...
public  class MyFlexTableHeader extends FlexTable implements HasMouseOverHandlers, HasMouseOutHandlers ,HasMouseMoveHandlers{
    /*
	private Element head;  
    private Element headerTr;
    */  
	public MyFlexTableHeader(){
		super();
		/*
	...
	public void onBrowserEvent(Event event) {
        ...
        switch (DOM.eventGetType(event)) {
        		...
        		case Event.ONMOUSEDOWN: {
                        DOM.setStyleAttribute(tr, "backgroundColor", "#F88017");                     
                        break;
                }
                ...
                */                
                case Event.ONMOUSEOVER: {
                        //DOM.setStyleAttribute(td, "backgroundColor", "#806517");
                        //DOM.setStyleAttribute(td, "cursor", "pointer");
                        td.getStyle().setProperty("backgroundColor", "#806517");
                        td.getStyle().setProperty("cursor", "pointer");
                        break;
                }
                
                case Event.ONMOUSEOUT: {
                        //DOM.setStyleAttribute(td, "backgroundColor","#2062B8");
                        td.getStyle().setProperty("backgroundColor","#2062B8");
                        break;
                }                             
       }
